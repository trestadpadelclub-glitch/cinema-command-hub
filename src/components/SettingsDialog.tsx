        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            ...
            <div className="rounded-md border border-border/50 bg-muted/30 p-3 text-xs text-muted-foreground space-y-1">
              ...
              <p>2. Starta bryggan (v38): <code>python Formuler_alfa_status_v38.py</code></p>
              ...
              <p className="pt-1 text-[10px]">
                <a href="/downloads/Formuler_alfa_status_v38.py" download className="text-primary underline">
                  Ladda ner v38
                </a>
                {" · "}
                <span>v38 innehåller MOL3-paus/start via ljudstatus, Lights-status och Chromecast-fjärrkontroll.</span>
              </p>
            </div>
          </div>
